...
import { assetsListPanel, commandAppendDialogue, commandAppendDialogue_impl, commandBasePath, commandBasePath_impl, commandGetAssetsList, commandGetAssetsList_impl, commandRefreshAssets, commandRefreshAssets_impl, commandRemoveEmptyLines, commandRemoveEmptyLines_impl, commandReplaceScript, commandReplaceScript_impl, commandShowDialogueFormatHint, commandShowDialogueFormatHint_impl, commandShowHibiscusDocument, commandShowHibiscusDocument_impl, commandShowJumpFlow, commandShowJumpFlow_impl, commandUpdateCommandExtension, commandUpdateCommandExtension_impl } from './functions/command';
...
export async function activate(context: vscode.ExtensionContext) {
	...
	// vscode.commands.registerCommand(commandRemoveEmptyLines, commandRemoveEmptyLines_impl);

            // {
            //     "category": "AvgScript",
            //     "command": "config.AvgScript.removeEmptyLines",
            //     "title": "Remove Empty Lines",
            //     "icon": "media/AvgScript.png",
            //     "shortTitle": "Remove Empty Lines"
            // }
